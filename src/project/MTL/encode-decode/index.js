async function encode(file,downloadFiles) {
  var pdfb64 = ''
  var reader = new FileReader();
  reader.readAsDataURL(file);
  reader.onload = function (pdfb64) {
    pdfb64 = reader.result.toString()
...
function fileType(readResult) {
  if (
    readResult.toString().includes("data:image/jpeg;base64") ||
    readResult.toString().includes("/9j/")
  ) {
    ...
    readResult.toString().includes("data:image/png;base64") ||
    readResult.toString().includes("iVBORw0KG")
  ) {
    ...
    readResult.toString().includes("data:application/pdf;base64,") ||
    readResult.toString().includes("JVBER")
  ) {
